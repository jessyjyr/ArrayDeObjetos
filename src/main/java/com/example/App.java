...
public class App 
{
    ...
    //Queremos crear un array que contenga tanto personas como coches, en el mismo 
    	...
    	//Para recorrer al array y operar con los elementos segun el tipo
    	for(Object object : personasYCoches) {
    		
    		//Tengo que determinar si el objeto es una instancia de Persona o de Coche para lo cual se utiliza
    		// el operador instanceof, que comprueba si un objeto es una instancia de algun tipo
